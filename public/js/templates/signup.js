  ...
  return function anonymous(locals, attrs, escape, rethrow, merge) {
    ...
    try {
      ...
      with (locals || {}) {
        ...
        buf.push('<input type="text" name="username" placeholder="Username" class="span12">');
        __jade.shift();
        __jade.unshift({
          lineno: 7,
          filename: __jade[0].filename
        });
        buf.push('<button class="span2 pull-right btn btn-warning">');
        __jade.unshift({
          lineno: undefined,
          filename: __jade[0].filename
        });
        ...
        buf.push('<input type="text" name="password" placeholder="Password" class="span10">');
        __jade.shift();
        __jade.shift();
        buf.push("</form>");
        __jade.shift();
        ...
        buf.push('<input type="text" name="name" placeholder="Full Name" class="span12">');
        __jade.shift();
        __jade.unshift({
          lineno: 12,
          filename: __jade[0].filename
        ...
        buf.push('<input type="text" name="email" placeholder="Email Address" class="span12">');
        __jade.shift();
        __jade.unshift({
          lineno: 14,
          filename: __jade[0].filename
        });
        buf.push('<input type="text" name="password" placeholder="Password" class="span12">');
        __jade.shift();
        __jade.unshift({
          lineno: 15,
          filename: __jade[0].filename
        });
        buf.push('<button class="pull-right btn btn-warning">');
        __jade.unshift({
          lineno: undefined,
          filename: __jade[0].filename
        });
